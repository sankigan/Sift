  ...
  >
    ...
    <div class="flex items-center gap-4 min-w-[200px] justify-end">
      ...
      <div class="flex items-center gap-1.5">
        <span class="w-2 h-2 rounded-full bg-sift-star" />
        <span class="text-xs text-sift-muted">
      ...
      <!-- Deleted -->
      <div class="flex items-center gap-1.5">
        <span class="w-2 h-2 rounded-full bg-sift-delete" />
        <span class="text-xs text-sift-muted">
      ...
      <!-- Skipped -->
      <div class="flex items-center gap-1.5">
        <span class="w-2 h-2 rounded-full bg-sift-skip" />
        <span class="text-xs text-sift-muted">
      ...
      <!-- Unprocessed -->
      <div class="flex items-center gap-1.5">
        <span class="w-2 h-2 rounded-full bg-sift-accent" />
        <span class="text-xs text-sift-muted">
